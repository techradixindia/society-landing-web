    ...
    return (<>
            <Carousel className='mt-8'>
                <Carousel.Item>
                    ...
                    <Link to='/contact'>   <button className="btn" style={{ background: '#ff5f13', color: "white", paddingLeft: '40px', paddingRight: '40px', paddingTop: '10px', paddingBottom: '10px', fontSize: '20px', fontWeight: 'bold' }} type="submit">Contact Us</button></Link>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                    <img
